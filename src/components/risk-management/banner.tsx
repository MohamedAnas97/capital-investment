    ...
    <div>
      ...
      <div className="mx-[5%] xl:mx-[7%] py-10">
        ...
        <p className="text-[16px] text-[#606060] font-[400] leading-[24px] font-inter pt-3">
          ...
          isn&apos;t just about chasing high returns; it&apos;s about
          safeguarding your investments against potential risks. With our robust
          risk management strategies, we&apos;re dedicated to helping our
          clients navigate the complexities of the financial markets with
